  ...
  return (
    <>
      <div className="grid grid-cols-12 gap-5 sm:gap-6">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#a3a3a3] text-sm sm:text-base font-medium leading-relaxed max-w-2xl font-sans selection:bg-blue-500 selection:text-black">
        ...
        >
          ...
          <div className="flex justify-between items-center pb-2 border-b border-neutral-900">
            <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest font-mono flex items-center gap-1.5">
              <Globe className="w-3.5 h-3.5 text-blue-500 animate-pulse" /> FILIPINO CITIZEN
            </span>
            <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[9px] font-mono font-bold rounded border border-blue-500/20">
              <span className="w-1 h-1 rounded-full bg-blue-400 animate-ping" /> MULTICULTURAL
            </div>
          </div>
          
          <div className="space-y-3.5 py-3">
            <p className="text-xs text-neutral-400 font-sans leading-relaxed selection:bg-blue-500 selection:text-black">
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest flex items-center gap-1">
                <Languages className="w-3 h-3 text-blue-400" /> Fluency in 4 Languages
              </span>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-[9px] font-mono">
                <div className="bg-neutral-950 p-2 border border-neutral-900 rounded-lg flex flex-col gap-0.5">
                  ...
                  <span className="text-[8px] text-blue-500">Professional</span>
                </div>
                <div className="bg-neutral-950 p-2 border border-neutral-900 rounded-lg flex flex-col gap-0.5">
                  <span className="text-neutral-200 font-extrabold">Tagalog</span>
                  <span className="text-[8px] text-blue-500">Native Colloquial</span>
                </div>
                <div className="bg-neutral-950 p-2 border border-neutral-900 rounded-lg flex flex-col gap-0.5">
                  <span className="text-neutral-200 font-extrabold">Hindi</span>
                  <span className="text-[8px] text-blue-500">Conversational</span>
                </div>
                <div className="bg-neutral-950 p-2 border border-neutral-900 rounded-lg flex flex-col gap-0.5">
                  <span className="text-neutral-200 font-extrabold">Punjabi</span>
                  <span className="text-[8px] text-blue-500">Heritage Dialect</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[#1a1a1a] pt-3 flex justify-between items-center font-mono text-[9px] text-neutral-500">
            ...
            <span className="text-blue-500 font-black">ADAPTABILITY MINDSET</span>
          </div>
        </section>

        {/* 03/ EXPERIENCE WORKSPACE */}
        <section 
              ...
              <div className="md:col-span-4 flex flex-col gap-3">
                <button
                  ...
                  className={`text-left p-4 rounded-2xl border transition-all duration-300 cursor-pointer ${
                    activeJob === 'cto' 
                        ? 'bg-gradient-to-r from-[#00d2ff] to-[#0a84ff] text-white border-transparent shadow-lg shadow-blue-600/25 font-bold scale-[1.02] hover:-translate-y-0.5 hover:scale-[1.03] hover:shadow-xl hover:shadow-blue-600/40' 
                        : 'bg-neutral-950 border-neutral-800 hover:border-[#0a84ff]/65 hover:bg-[#070707] text-neutral-300 hover:text-white hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/5'
                    }`}
                >
                  <div className="flex justify-between items-start">
                    <span className="text-xs font-mono tracking-wider font-extrabold uppercase">AUSCULTATE</span>
                    <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded ${activeJob === 'cto' ? 'bg-black text-[#0a84ff]' : 'bg-neutral-900 text-neutral-400'}`}>PRESENT</span>
                  </div>
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded ${activeJob === 'comelec' ? 'bg-black text-[#0a84ff]' : 'bg-neutral-900 text-neutral-400'}`}>PRESENT</span>
                  </div>
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded ${activeJob === 'chatbot' ? 'bg-black text-[#0a84ff]' : 'bg-neutral-900 text-neutral-400'}`}>FORMER</span>
                  </div>
                ...
                <div>
                    ...
                    <div className="space-y-4 animate-in fade-in duration-300">
                      <div className="flex flex-wrap justify-between items-center gap-2 border-b border-neutral-900 pb-3">
                        <div>
                          ...
                          <p className="text-xs font-mono text-blue-500 font-bold mt-0.5">Auscultate · Dec 2025 – Current</p>
                        </div>
                        <span className="px-2.5 py-1 text-[10px] font-mono bg-blue-500/10 text-blue-500 border border-blue-500/20 rounded font-bold uppercase select-none">BIOMEDICAL SYSTEMS</span>
                      </div>

                      <ul className="space-y-3">
                        <li className="flex items-start gap-2.5 text-xs sm:text-sm text-neutral-300 leading-relaxed font-sans">
                          <span className="text-blue-500 select-none pt-0.5">▶</span>
                  ...
                  {activeJob === 'comelec' && (
                    <div className="space-y-4 animate-in fade-in duration-300">
                      <div className="flex flex-wrap justify-between items-center gap-2 border-b border-neutral-900 pb-3">
                        <div>
                          <h5 className="text-lg font-display font-extrabold text-white">IT Department Head</h5>
                          <p className="text-xs font-mono text-blue-500 font-bold mt-0.5">Saint Louis University · Jan 2025 – Current</p>
                        </div>
                        <span className="px-2.5 py-1 text-[10px] font-mono bg-blue-500/10 text-blue-500 border border-blue-500/20 rounded font-bold uppercase select-none">CYBERSECURITY / INFRASTRUCTURE</span>
                      </div>
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-2.5 text-xs sm:text-sm text-neutral-300 leading-relaxed font-sans">
                          <span className="text-blue-500 select-none pt-0.5">▶</span>
                          <span>Implemented cybersecurity measures to protect sensitive data and maintain compliance with industry standards.</span>
                        </li>
                        <li className="flex items-start gap-2.5 text-xs sm:text-sm text-neutral-300 leading-relaxed font-sans">
                          <span className="text-blue-500 select-none pt-0.5">▶</span>
                    ...
                    <div className="space-y-4 animate-in fade-in duration-300">
                      <div className="flex flex-wrap justify-between items-center gap-2 border-b border-neutral-900 pb-3">
                        <div>
                          ...
                          <p className="text-xs font-mono text-blue-500 font-bold mt-0.5">Saint Louis University · Jun 2025 – Aug 2025</p>
                        </div>
                        <span className="px-2.5 py-1 text-[10px] font-mono bg-blue-500/10 text-blue-500 border border-blue-500/20 rounded font-bold uppercase select-none">AI / AGENT SYSTEMS</span>
                      </div>
                      ...
                      <div className="border border-neutral-900 bg-[#040404] p-3 rounded-xl mt-4 flex items-center justify-between font-mono text-[10px] text-neutral-500">
                        <span className="flex items-center gap-1.5">
                          <span className="w-2 h-2 rounded bg-blue-500"></span> RASA & Hybrid RAG Engine
                        </span>
      ...
      >
        ...
        <section 
          id="skills-section" 
          className="bg-neutral-900/40 border border-neutral-800 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 hover:border-[#0a84ff]/40 hover:shadow-[0_0_25px_rgba(10,132,255,0.06)] hover:-translate-y-1 hover:scale-[1.01] hover:bg-[#080808]"
        >
          <div>
            <div className="border-b border-neutral-850 pb-4 mb-4 flex justify-between items-center">
              <span className="font-mono text-xs font-bold tracking-widest text-[#0a84ff] select-none flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {activeSkills.map(skill => (
                <span 
                  key={skill.name} 
                  className="px-3 py-1.5 bg-neutral-950/80 text-neutral-300 rounded-xl border border-neutral-800 text-xs font-mono select-none hover:border-blue-500/40 hover:text-white hover:scale-105 transition-all duration-200 cursor-default"
                >
                  {skill.name}
                </span>
              ))}
        ...
        >
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-blue-500 font-extrabold font-mono text-xs sm:text-sm mt-0.5">
                B.S. Computer Science
              </p>

              {/* Honors Accreditation Card - High Contrast Ribbon Accent */}
              <div className="border border-neutral-850 bg-neutral-950 p-4 rounded-2xl text-center select-none shadow-inner border-l-4 border-l-blue-500 mt-6 space-y-1.5">
                ...
                <p className="font-sans text-xs sm:text-sm font-semibold text-neutral-300 tracking-wide leading-relaxed">
                  Summa Cum Laude 
                  <br/><span className="mx-1 text-blue-500/20">•</span> Consistent Dean's Lister
                  <br/><span className="mx-1 text-blue-500/20">•</span> Devesse Award for Exemplary Performance in Academics Recipient
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-neutral-900 pt-5 mt-8 flex justify-between items-center text-xs">
            ...
            <span className="font-mono font-extrabold text-blue-500">AI • Database • Data Science</span>
          </div>
        </section>
        ...
        >
          <div>
            ...
            <div className="space-y-2.5 max-h-[330px] overflow-y-auto pr-1.5 scrollbar-thin">
              {CERTIFICATIONS.map((cert, index) => (
                <div 
                  key={index} 
                  className="bg-neutral-950 p-3 rounded-xl border border-neutral-900 flex flex-col gap-1 hover:border-[#0a84ff]/30 transition-all duration-300"
                >
                  <div className="flex justify-between items-start gap-3">
                    <span className="font-sans font-bold text-neutral-200 text-xs leading-snug">
                      {cert.title}
                    </span>
                    <span className="font-mono text-[9px] text-[#0a84ff] bg-blue-500/10 px-1.5 py-0.5 rounded shrink-0 font-extrabold border border-blue-500/10">
                      {cert.date}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center text-[10px] font-mono mt-0.5">
                    ...
                    {cert.status && (
                      <span className="text-white-500 text-[8px] tracking-widest uppercase font-black px-1.5 py-0.2 rounded bg-blue-500/10 border border-blue-500/10 animate-pulse">
                        {cert.status}
                      </span>
                    )}
                  </div>
          ...
          <div className="border-t border-neutral-900 pt-5 mt-6 flex justify-between items-center text-xs">
            ...
            <span className="font-mono font-extrabold text-blue-500">9 CREDENTIALS</span>
          </div>
        </section>
