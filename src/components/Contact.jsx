...
export default function Contact() {
  ...
  return (
    <section 
      id="contact-section" 
      className="bg-neutral-900/40 border border-neutral-800 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden transition-all duration-300 hover:border-[#0a84ff]/40 hover:shadow-[0_0_25px_rgba(10,132,255,0.06)] hover:-translate-y-1 hover:scale-[1.01] hover:bg-[#080808] mt-6"
    >
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="space-y-3 pt-2 font-mono text-xs">
              ...
              <div className="p-3 bg-neutral-950 rounded-xl border border-neutral-900 flex items-center justify-between group">
                ...
                <a 
                  ...
                  className="text-[#0a84ff] font-bold hover:underline transition-all"
                >
              ...
              <div className="p-3 bg-neutral-950 rounded-xl border border-neutral-900 flex items-center justify-between">
                ...
                <a href="tel:+639177900153"
                  className="text-[#0a84ff] font-bold hover:underline transition-all">+63 917-790-0153</a>
              </div>
            ...
            <div className="flex gap-3 pt-2">
               <a 
                 ...
                 target="_blank" 
                 rel="noreferrer"
                 className="flex-1 py-2 bg-neutral-950 border border-neutral-800 hover:border-[#0a84ff]/30 font-mono text-[10px] text-zinc-400 font-bold uppercase rounded-xl flex items-center justify-center gap-1.5 transition-all"
               >
          ...
          >
            <div className="space-y-1">
              ...
              <input 
                ...
                className="w-full bg-neutral-950 border border-neutral-910 rounded-xl px-3 py-2 text-xs text-white placeholder-zinc-700 focus:outline-none focus:border-[#0a84ff]/50 transition-colors"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <textarea 
                ...
                disabled={formSending || formSuccess}
                className="w-full bg-neutral-950 border border-neutral-910 rounded-xl px-3 py-2 text-xs text-white placeholder-zinc-700 focus:outline-none focus:border-[#0a84ff]/50 transition-colors resize-none"
              />
            </div>

            {formSuccess ? (
              <div className="bg-blue-500/10 border border-blue-500/30 p-3.5 rounded-xl font-mono text-[10px] text-[#0a84ff] space-y-1.5">
                <p className="font-extrabold flex items-center gap-1.5 uppercase">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#0a84ff] animate-pulse" /> TELEMETRY OUTBOX PIPELINE SUCCEEDED
                </p>
                <p className="text-[9px] text-[#8c8c8c]">
                  Thank you {contactName}. Your message has been sent. Email: {contactEmail} can expect a response within the next 2-3 business days.
                </p>
              </div>
            ) : (
              <button
                ...
                className={`w-full py-2.5 font-mono text-[11px] font-bold uppercase rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                  formSending
                    ...
                    : 'bg-gradient-to-r from-[#00d2ff] to-[#0a84ff] font-black text-white shadow-lg shadow-blue-500/10 hover:shadow-[#0a84ff]/20 hover:scale-[1.01]'
                }`}
              >
